    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.subtitle}>
          Регистрация пользователей в системе. Пользователи могут сразу входить в приложение без SMS кодов.
        </p>
      </div>
      ...
      {showAddForm && (
        <div style={styles.addForm}>
          ...
          <p style={styles.formNote}>
            💡 Пользователь будет сразу зарегистрирован и сможет входить в приложение с кодом 123456
          </p>
      ...
      <div style={styles.info}>
        ...
        <ul>
          ...
          <li>🔐 Используют код подтверждения 123456 (в разработке)</li>
          <li>🚫 SMS коды отключены</li>
